...
import 'package:drop_here_mobile/routes/bloc/add_products_to_route_bloc/add_products_to_route_bloc.dart';
                      ...
                      children: [
                        for (ProductResponse product in bloc.state.products ?? [])
                          AddProductToRouteCard(
                              bloc: bloc,
                              product: product,
                              productRequest: bloc.state.selectedProducts.firstWhere(
        ...
        children: [
          ...
          Align(
            child: SubmitFormButton(
              ...
              isActive:
                  (!_limited || (product.amount != null && product.amount.toString() != "")) &&
