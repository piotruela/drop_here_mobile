...
class ShipmentDetailsPage extends BlocWidget<CompanyShipmentBloc> {
                    ...
                    children: ConditionalSwitch.list(
                        ...
                        caseBuilders: {
                          ShipmentStatus.PLACED: (BuildContext context) => <Widget>[
                                _changeStatusButton(bloc, CompanyDecision.ACCEPT),
                                _changeStatusButton(bloc, CompanyDecision.REJECT),
                              ],
                          ShipmentStatus.ACCEPTED: (BuildContext context) => <Widget>[
                                _changeStatusButton(bloc, CompanyDecision.DELIVER),
                                _changeStatusButton(bloc, CompanyDecision.REJECT),
                              ],
                          ShipmentStatus.CANCEL_REQUESTED: (BuildContext context) => <Widget>[
                                _changeStatusButton(bloc, CompanyDecision.CANCEL),
                                _changeStatusButton(bloc, CompanyDecision.DELIVER),
                              ],
                        },
  ...
  Widget _changeStatusButton(CompanyShipmentBloc bloc, CompanyDecision status) {
